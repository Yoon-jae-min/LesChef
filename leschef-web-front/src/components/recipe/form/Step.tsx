...
export default function Step({
  ...
  const inputClass =
    "w-full rounded-xl border border-stone-200 bg-white px-4 py-3 text-sm text-stone-900 placeholder:text-stone-500 transition focus:outline-none focus-visible:border-green-400 focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2";
  const fileClass = `${inputClass} file:mr-3 file:rounded-lg file:border-0 file:bg-green-50 file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-green-800 hover:file:bg-green-100`;
        ...
        {steps.map((step, index) => (
          ...
          >
            <div className="mb-4 flex flex-wrap items-center gap-3">
              <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-green-600 text-sm font-bold text-white shadow-sm">
                {step.stepNum}
              </span>
            ...
            <div className="space-y-3">
              ...
              <div>
                {step.stepImg ? (
                  ...
                  <div className="relative mb-2 flex h-48 w-full items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-stone-300 bg-gradient-to-br from-stone-50 to-green-50/30">
