...
export const toggleWish = asyncHandler(async(req: Request<{}, ToggleWishResponse | ApiErrorResponse, ToggleWishRequestBody>, res: Response<ToggleWishResponse | ApiErrorResponse>) => {
    // 세션 검증
