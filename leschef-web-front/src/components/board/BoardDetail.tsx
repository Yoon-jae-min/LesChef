...
import { fetchBoardDetail, type BoardDetailResponse } from "@/utils/api/board";
            ...
            <div className="rounded-[32px] border border-gray-200 bg-white p-6 shadow-[6px_6px_0_rgba(0,0,0,0.05)]">
              ...
              <div className="space-y-4">
                {comments.map((comment) => (
                  <div key={comment._id} className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-5">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3 mb-3">
                        ...
                        <span className="text-base font-medium text-gray-900">{comment.nickName || "익명"}</span>
